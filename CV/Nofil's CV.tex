...
\researchHeadingLong
        ...
        \resumeItemListStart
            \small\resumeItem{Supervisor: Dr. Muhammad Arif Butt}
            \resumeItem{Worked on the final draft of the paper}
        \resumeItemListEnd
...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
        ...
        \resumeItemListStart
            \small\resumeItem{Level 1 Security Operations Center (SOC) Analysis}
            \resumeItem{Web Application Penetration Testing}
        \resumeItemListEnd
...
% \begin{itemize}[leftmargin=0.15in, label={}]
%     \normalsize{\item{
%         \textbf{Teaching}{: Mentoring outside of TAships and classroom settings} \\
%         \textbf{Art}{: Approaching exploitation with an artists mindset} \\
%     }}    
%  \end{itemize}
